...
namespace PixelStacker.Logic.Model
{
    ...
    {
        /** Not available **/
        private const int NA = Constants.BlockID_Unavailable;
            ...
            get
            {
                if (_List == null)
                {
                    ...
                    _List = new List<Material>()
                    {
                        ...
                        new Material("1.19", false, "Planks", "PLANK_MANGROVE", "Planks Mangrove", 5, 6, Textures.mangrove_planks, Textures.mangrove_planks, $"minecraft:{nameof(Textures.mangrove_planks)}", $"minecraft:{nameof(Textures.mangrove_planks)}", "minecraft:planks"),
                        new Material("1.16", false, "Planks", "PLANK_CRIMSON", "Planks Crimson", 5, 7, Textures.crimson_planks, Textures.crimson_planks, $"minecraft:{nameof(Textures.crimson_planks)}", $"minecraft:{nameof(Textures.crimson_planks)}", ""),
                        new Material("1.16", false, "Planks", "PLANK_WARPED", "Planks Warped", 5, 8, Textures.warped_planks, Textures.warped_planks, $"minecraft:{nameof(Textures.warped_planks)}", $"minecraft:{nameof(Textures.warped_planks)}", ""),
                        // cherry and bamboo
                        new Material("1.20", false, "Planks", "PLANK_BAMBOO", "Planks Bamboo", 5, 9, Textures.bamboo_planks, Textures.bamboo_planks, $"minecraft:{nameof(Textures.bamboo_planks)}", $"minecraft:{nameof(Textures.bamboo_planks)}", "minecraft:planks"),
                        new Material("1.20", false, "Planks", "PLANK_BAMBOOMOSAIC", "Mosaics Bamboo", 5, 9, Textures.bamboo_mosaic, Textures.bamboo_mosaic, $"minecraft:{nameof(Textures.bamboo_mosaic)}", $"minecraft:{nameof(Textures.bamboo_mosaic)}", "minecraft:planks"),
                        new Material("1.20", false, "Planks", "PLANK_CHERRY", "Planks Cherry", 5, 10, Textures.cherry_planks, Textures.cherry_planks, $"minecraft:{nameof(Textures.cherry_planks)}", $"minecraft:{nameof(Textures.cherry_planks)}", "minecraft:planks"),
                        ...
                        new Material("1.19", false, "Stripped", "STRIP_LOG_MANGRO", "Stripped Mangrove", 17, 0, Textures.stripped_mangrove_log, Textures.stripped_mangrove_log, $"minecraft:{nameof(Textures.stripped_mangrove_log)}[axis=x]", $"minecraft:{nameof(Textures.stripped_mangrove_log)}[axis=x]", ""),
                        new Material("1.16", false, "Stripped", "STRIP_LOG_CRIMSON", "Stripped Crimson Hyphae", 17, 0, Textures.stripped_crimson_stem, Textures.stripped_crimson_stem, $"minecraft:stripped_crimson_hyphae[axis=x]", $"minecraft:stripped_crimson_hyphae[axis=x]", ""),
                        new Material("1.16", false, "Stripped", "STRIP_LOG_WARPED", "Stripped Warped Hyphae", 17, 0, Textures.stripped_warped_stem, Textures.stripped_warped_stem, $"minecraft:stripped_warped_hyphae[axis=x]", $"minecraft:stripped_warped_hyphae[axis=x]", ""),
                        // cherry and bamboo
                        new Material("1.20", false, "Stripped", "STRIP_LOG_BAMBOO", "Stripped Bamboo", 17, 0, Textures.stripped_bamboo_block, Textures.stripped_bamboo_block, $"minecraft:{nameof(Textures.stripped_bamboo_block)}[axis=x]", $"minecraft:{nameof(Textures.stripped_bamboo_block)}[axis=x]", ""),  
                        new Material("1.20", false, "Stripped", "STRIP_LOG_CHERRY", "Stripped Cherry", 17, 0, Textures.stripped_cherry_log, Textures.stripped_cherry_log, $"minecraft:{nameof(Textures.stripped_cherry_log)}[axis=x]", $"minecraft:{nameof(Textures.stripped_cherry_log)}[axis=x]", ""),
                        ...
                        new Material("1.19", false, "Logs Top", "STUMP_LOG_MANGRO", "Stripped Mangrove (Top)", 17, 0, Textures.stripped_mangrove_log_top, Textures.stripped_mangrove_log_top, $"minecraft:{nameof(Textures.stripped_mangrove_log)}[axis=y]", $"minecraft:{nameof(Textures.stripped_mangrove_log)}[axis=z]", ""),
                        new Material("1.16", false, "Logs Top", "STUMP_LOG_CRIMSON", "Crimson Stem (Top)", 17, 0, Textures.stripped_crimson_stem_top, Textures.stripped_crimson_stem_top, $"minecraft:stripped_crimson_stem[axis=y]", $"minecraft:stripped_crimson_stem[axis=z]", ""),
                        new Material("1.16", false, "Logs Top", "STUMP_LOG_WARPED", "Warped Stem (Top)", 17, 0, Textures.stripped_warped_stem_top, Textures.stripped_warped_stem_top, $"minecraft:stripped_warped_stem[axis=y]", $"minecraft:stripped_warped_stem[axis=z]", ""),
                        // cherry and bamboo
                        new Material("1.20", false, "Logs Top", "STUMP_LOG_BAMBOO", "Stripped Bamboo (Top)", 17, 0, Textures.stripped_bamboo_block_top, Textures.stripped_bamboo_block_top, $"minecraft:{nameof(Textures.stripped_bamboo_block)}[axis=y]", $"minecraft:{nameof(Textures.stripped_bamboo_block)}[axis=z]", ""),
                        new Material("1.20", false, "Logs Top", "STUMP_LOG_CHERRY", "Stripped Cherry (Top)", 17, 0, Textures.stripped_cherry_log_top, Textures.stripped_cherry_log_top, $"minecraft:{nameof(Textures.stripped_cherry_log)}[axis=y]", $"minecraft:{nameof(Textures.stripped_cherry_log)}[axis=z]", ""),
                        ...
                        new Material("1.16", false, "Good", "NETHER_WART_WARPED", "Warped Netherwart", NA, 0, Textures.warped_wart_block, Textures.warped_wart_block, $"minecraft:{nameof(Textures.warped_wart_block)}", $"minecraft:{nameof(Textures.warped_wart_block)}", ""),
                        ...
                        new Material("1.15", false, "Okay", "HONEYCOMB", "Honeycomb Block", NA, 0, Textures.honeycomb_block, Textures.honeycomb_block, $"minecraft:{nameof(Textures.honeycomb_block)}", $"minecraft:{nameof(Textures.honeycomb_block)}", ""),
                        ...
                        new Material("1.16", false, "Bricks", "NETHER_BRICK_CHIZ", "Chiseled Nether Brick", NA, 0, Textures.chiseled_nether_bricks, Textures.chiseled_nether_bricks, $"minecraft:{nameof(Textures.chiseled_nether_bricks)}", $"minecraft:{nameof(Textures.chiseled_nether_bricks)}", ""),
                        new Material("1.16", true, "Bricks", "NETHER_BRICK_CRK", "Cracked Nether Brick", NA, 0, Textures.cracked_nether_bricks, Textures.cracked_nether_bricks, $"minecraft:{nameof(Textures.cracked_nether_bricks)}", $"minecraft:{nameof(Textures.cracked_nether_bricks)}", ""),
                        new Material("1.16", true, "Bricks", "BLK_STONE_CRK_PLSHD_BRK", "Cracked Polished Blackstone Bricks", NA, 0, Textures.cracked_polished_blackstone_bricks, Textures.cracked_polished_blackstone_bricks, $"minecraft:{nameof(Textures.cracked_polished_blackstone_bricks)}", $"cracked_polished_blackstone_bricks", ""),
                        ...
                        new Material("1.16", false, "Nether", "BASALT_TOP", "Basalt", NA, 0, Textures.basalt_top, Textures.basalt_top, $"minecraft:basalt[axis=y]", $"minecraft:basalt[axis=z]", ""),
                        new Material("1.16", false, "Nether", "BASALT_SIDE", "Basalt", NA, 0, Textures.basalt_side, Textures.basalt_side, $"minecraft:basalt[axis=x]", $"minecraft:basalt[axis=x]", ""),
                        new Material("1.16", false, "Nether", "BASALT_POLISHED_TOP", "Basalt (Polished)", NA, 0, Textures.polished_basalt_top, Textures.polished_basalt_top, $"minecraft:polished_basalt[axis=y]", $"minecraft:polished_basalt[axis=z]", ""),
                        new Material("1.16", false, "Nether", "BASALT_POLISHED_SIDE", "Basalt (Polished)", NA, 0, Textures.polished_basalt_side, Textures.polished_basalt_side, $"minecraft:polished_basalt[axis=x]", $"minecraft:polished_basalt[axis=x]", ""),
                        new Material("1.17", false, "Nether", "BASALT_SMOOTH", "Basalt (Smooth)", NA, 0, Textures.smooth_basalt, Textures.smooth_basalt, $"minecraft:smooth_basalt", $"minecraft:smooth_basalt", ""),
                        new Material("1.16", false, "Nether", "NETHERITE_BLOCK", "Netherite Block", NA, 0, Textures.netherite_block, Textures.netherite_block, $"minecraft:{nameof(Textures.netherite_block)}", $"minecraft:{nameof(Textures.netherite_block)}", ""),
                        new Material("1.16", false, "Nether", "NYLIUM_CRIMSON", "Crimson Nylium", NA, 0, Textures.crimson_nylium, Textures.crimson_nylium_side, $"minecraft:{nameof(Textures.crimson_nylium)}", $"minecraft:{nameof(Textures.crimson_nylium)}", ""),
                        new Material("1.16", false, "Nether", "NYLIUM_WARPED", "Warped Nylium", NA, 0, Textures.warped_nylium, Textures.warped_nylium_side, $"minecraft:{nameof(Textures.warped_nylium)}", $"minecraft:{nameof(Textures.warped_nylium)}", ""),
                        new Material("1.16", false, "Nether", "BLK_STONE", "Blackstone", NA, 0, Textures.blackstone_top, Textures.blackstone, $"minecraft:blackstone", $"minecraft:blackstone", ""),
                        ...
                        new Material("1.17", false, "Other", "CALCITE", "Calcite", NA, 0, Textures.calcite, Textures.calcite, $"minecraft:{nameof(Textures.calcite)}", $"minecraft:{nameof(Textures.calcite)}",""),
                        new Material("1.17", false, "Other", "CHZL_DEEPSLATE", "Chiseled Deepslate", NA, 0, Textures.chiseled_deepslate, Textures.chiseled_deepslate, $"minecraft:{nameof(Textures.chiseled_deepslate)}", $"minecraft:{nameof(Textures.chiseled_deepslate)}",""),
                        new Material("1.17", true, "Other", "CRACKED_DEEPSLATE_BRICK", "Cracked Deepslate Bricks", NA, 0, Textures.cracked_deepslate_bricks, Textures.cracked_deepslate_bricks, $"minecraft:{nameof(Textures.cracked_deepslate_bricks)}", $"minecraft:{nameof(Textures.cracked_deepslate_bricks)}",""),
                        new Material("1.17", true, "Other", "CRACKED_DEEPSLATE_TILE", "Cracked Deepslate Tiles", NA, 0, Textures.cracked_deepslate_tiles, Textures.cracked_deepslate_tiles, $"minecraft:{nameof(Textures.cracked_deepslate_tiles)}", $"minecraft:{nameof(Textures.cracked_deepslate_tiles)}",""),
                        new Material("1.17", false, "Other", "COBBLE_DEEPSLATE", "Cobbled Deepslate", NA, 0, Textures.cobbled_deepslate, Textures.cobbled_deepslate, $"minecraft:{nameof(Textures.cobbled_deepslate)}", $"minecraft:{nameof(Textures.cobbled_deepslate)}",""),
                        new Material("1.17", false, "Other", "DEEPSLATE", "Deepslate", NA, 0, Textures.deepslate_top, Textures.deepslate, $"minecraft:{nameof(Textures.deepslate)}", $"minecraft:{nameof(Textures.deepslate)}",""),
                        new Material("1.17", false, "Other", "DEEPSLATE_BRICK", "Deepslate Bricks", NA, 0, Textures.deepslate_bricks, Textures.deepslate_bricks, $"minecraft:{nameof(Textures.deepslate_bricks)}", $"minecraft:{nameof(Textures.deepslate_bricks)}",""),
                        new Material("1.17", false, "Other", "DEEPSLATE_TILE", "Deepslate Tiles", NA, 0, Textures.deepslate_tiles, Textures.deepslate_tiles, $"minecraft:{nameof(Textures.deepslate_tiles)}", $"minecraft:{nameof(Textures.deepslate_tiles)}",""),
                        new Material("1.17", false, "Other", "POLISH_DEEPSLATE", "Polished Deepslatee", NA, 0, Textures.polished_deepslate, Textures.polished_deepslate, $"minecraft:{nameof(Textures.polished_deepslate)}", $"minecraft:{nameof(Textures.polished_deepslate)}",""),
                        new Material("1.17", false, "Other", "TUFF", "Tuff", NA, 0, Textures.tuff, Textures.tuff, $"minecraft:{nameof(Textures.tuff)}", $"minecraft:{nameof(Textures.tuff)}",""),
                        ...
                        new Material("1.17", false, "Ores (Solid)", "AMETHYST_BD", "Amethyst Block", NA, 0, Textures.amethyst_block, Textures.amethyst_block, $"minecraft:{nameof(Textures.amethyst_block)}", $"minecraft:{nameof(Textures.amethyst_block)}", ""),
                        new Material("1.17", false, "Ores (Solid)", "AMETHYST_BLK", "Budding Amethyst", NA, 0, Textures.budding_amethyst, Textures.budding_amethyst, $"minecraft:{nameof(Textures.budding_amethyst)}", $"minecraft:{nameof(Textures.budding_amethyst)}", ""),
                        new Material("1.17", false, "Ores (Solid)", "SLD_ORE_Cu_BLK", "Copper Block (Waxed)", NA, 0, Textures.copper_block, Textures.copper_block, $"minecraft:waxed_copper", $"minecraft:waxed_copper",""),
                        new Material("1.17", false, "Ores (Solid)", "SLD_ORE_Cu_CUT", "Cut Copper Block (Waxed)", NA, 0, Textures.cut_copper, Textures.cut_copper, $"minecraft:waxed_cut_copper", $"minecraft:waxed_cut_copper",""),
                        new Material("1.17", false, "Ores (Solid)", "SLD_ORE_Cu_EXPO", "Exposed Copper Block (Waxed)", NA, 0, Textures.exposed_copper, Textures.exposed_copper, $"minecraft:waxed_exposed_copper", $"minecraft:waxed_exposed_copper",""),
                        new Material("1.17", false, "Ores (Solid)", "SLD_ORE_Cu_EXPO_CUT", "Exposed Cut Copper Block (Waxed)", NA, 0, Textures.exposed_cut_copper, Textures.exposed_cut_copper, $"minecraft:waxed_exposed_cut_copper", $"minecraft:waxed_exposed_cut_copper",""),
                        new Material("1.17", false, "Ores (Solid)", "SLD_ORE_Cu_OXI", "Oxidized Copper Block (Waxed)", NA, 0, Textures.oxidized_copper, Textures.oxidized_copper, $"minecraft:waxed_oxidized_copper", $"minecraft:waxed_oxidized_copper",""),
                        new Material("1.17", false, "Ores (Solid)", "SLD_ORE_Cu_OXI_CUT", "Oxidized Cut Copper Block (Waxed)", NA, 0, Textures.oxidized_cut_copper, Textures.oxidized_cut_copper, $"minecraft:waxed_oxidized_cut_copper", $"minecraft:waxed_oxidized_cut_copper",""),
                        new Material("1.17", false, "Ores (Solid)", "SLD_ORE_Cu_WTHER", "Weathered Copper Block (Waxed)", NA, 0, Textures.weathered_copper, Textures.weathered_copper, $"minecraft:waxed_weathered_copper", $"minecraft:waxed_weathered_copper",""),
                        new Material("1.17", false, "Ores (Solid)", "SLD_ORE_Cu_WTHER_CUT", "Weathered Cut Copper Block (Waxed)", NA, 0, Textures.weathered_cut_copper, Textures.weathered_cut_copper, $"minecraft:waxed_weathered_cut_copper", $"minecraft:waxed_weathered_cut_copper",""),
                       ...
                       new Material("1.10", false, "Common", "BONE_BLK", "Bone Block", 216, 4, Textures.bone_block_side, Textures.bone_block_side, $"minecraft:bone_block[axis=x]", $"minecraft:bone_block[axis=x]", "minecraft:bone_block"),
                        ...
                        new Material("1.13", true, "Coral", "CRL_FIRE", "Fire Coral", NA, 0, Textures.fire_coral_block, Textures.fire_coral_block, $"minecraft:{nameof(Textures.fire_coral_block)}", $"minecraft:{nameof(Textures.fire_coral_block)}", ""),
                        new Material("1.13", true, "Coral", "CRL_HORN", "Horn Coral", NA, 0, Textures.horn_coral_block, Textures.horn_coral_block, $"minecraft:{nameof(Textures.horn_coral_block)}", $"minecraft:{nameof(Textures.horn_coral_block)}", ""),
                        new Material("1.13", true, "Coral", "CRL_TUBE", "Tube Coral", NA, 0, Textures.tube_coral_block, Textures.tube_coral_block, $"minecraft:{nameof(Textures.tube_coral_block)}", $"minecraft:{nameof(Textures.tube_coral_block)}", ""),
                        new Material("1.13", false, "Coral", "KELP_DRIED", "Dried Kelp", NA, 0, Textures.dried_kelp_top, Textures.dried_kelp_side, $"minecraft:dried_kelp_block", $"minecraft:dried_kelp_block", ""),

                        new Material("1.13", false, "Dead Coral", "DEAD_CRL_BRAIN", "Dead Brain Coral", NA, 0, Textures.dead_brain_coral_block, Textures.dead_brain_coral_block, $"minecraft:{nameof(Textures.dead_brain_coral_block)}", $"minecraft:{nameof(Textures.dead_brain_coral_block)}", ""),
                        new Material("1.13", false, "Dead Coral", "DEAD_CRL_BUBBLE", "Dead Bubble Coral", NA, 0, Textures.dead_bubble_coral_block, Textures.dead_bubble_coral_block, $"minecraft:{nameof(Textures.dead_bubble_coral_block)}", $"minecraft:{nameof(Textures.dead_bubble_coral_block)}", ""),
                        new Material("1.13", false, "Dead Coral", "DEAD_CRL_FIRE", "Dead Fire Coral", NA, 0, Textures.dead_fire_coral_block, Textures.dead_fire_coral_block, $"minecraft:{nameof(Textures.dead_fire_coral_block)}", $"minecraft:{nameof(Textures.dead_fire_coral_block)}", ""),
                        new Material("1.13", false, "Dead Coral", "DEAD_CRL_HORN", "Dead Horn Coral", NA, 0, Textures.dead_horn_coral_block, Textures.dead_horn_coral_block, $"minecraft:{nameof(Textures.dead_horn_coral_block)}", $"minecraft:{nameof(Textures.dead_horn_coral_block)}", ""),
                        new Material("1.13", false, "Dead Coral", "DEAD_CRL_TUBE", "Dead Tube Coral", NA, 0, Textures.dead_tube_coral_block, Textures.dead_tube_coral_block, $"minecraft:{nameof(Textures.dead_tube_coral_block)}", $"minecraft:{nameof(Textures.dead_tube_coral_block)}", ""),
                        ...
                        new Material("1.16", false, "Ores", "ORE_G_NETHER", "Nether Gold Ore", NA, 0, Textures.nether_gold_ore, Textures.nether_gold_ore, $"minecraft:{nameof(Textures.nether_gold_ore)}", $"minecraft:{nameof(Textures.nether_gold_ore)}", ""),
                        new Material("1.16", false, "Ores", "BLK_STONE_GILDED", "Guilded Blackstone", NA, 0, Textures.gilded_blackstone, Textures.gilded_blackstone, $"minecraft:{nameof(Textures.gilded_blackstone)}", $"minecraft:{nameof(Textures.gilded_blackstone)}", ""),
                        ...
                        new Material("1.17", false, "Ores", "ORE_Cp_RAW", "Raw Copper Block", NA, 0, Textures.raw_copper_block, Textures.raw_copper_block, $"minecraft:{nameof(Textures.raw_copper_block)}", $"minecraft:{nameof(Textures.raw_copper_block)}", ""),
                        ...
                        new Material("1.17", true, "Ores (Deepslate)", "ORE_C_DS", "Deepslate Coal Ore", NA, 0, Textures.deepslate_coal_ore, Textures.deepslate_coal_ore, $"minecraft:{nameof(Textures.deepslate_coal_ore)}", $"minecraft:{nameof(Textures.deepslate_coal_ore)}", "minecraft:deepslate_coal_ore"),
                        new Material("1.17", true, "Ores (Deepslate)", "ORE_Cu_DS", "Deepslate Copper Ore", NA, 0, Textures.deepslate_copper_ore, Textures.deepslate_copper_ore, $"minecraft:{nameof(Textures.deepslate_copper_ore)}", $"minecraft:{nameof(Textures.deepslate_copper_ore)}", "minecraft:deepslate_copper_ore"),
                        new Material("1.17", true, "Ores (Deepslate)", "ORE_I_DS", "Deepslate Iron Ore", NA, 0, Textures.deepslate_iron_ore, Textures.deepslate_iron_ore, $"minecraft:{nameof(Textures.deepslate_iron_ore)}", $"minecraft:{nameof(Textures.deepslate_iron_ore)}", "minecraft:deepslate_iron_ore"),
                        new Material("1.17", true, "Ores (Deepslate)", "ORE_G_DS", "Deepslate Gold Ore", NA, 0, Textures.deepslate_gold_ore, Textures.deepslate_gold_ore, $"minecraft:gold_ore", $"minecraft:gold_ore", "minecraft:deepslate_gold_ore"),
                        new Material("1.17", true, "Ores (Deepslate)", "ORE_R_DS", "Deepslate Redstone Ore", NA, 0, Textures.deepslate_redstone_ore, Textures.deepslate_redstone_ore, $"minecraft:{nameof(Textures.deepslate_redstone_ore)}", $"minecraft:{nameof(Textures.deepslate_redstone_ore)}", "minecraft:deepslate_redstone_ore"),
                        new Material("1.17", true, "Ores (Deepslate)", "ORE_L_DS", "Deepslate Lapis Ore", NA, 0, Textures.deepslate_lapis_ore, Textures.deepslate_lapis_ore, $"minecraft:{nameof(Textures.deepslate_lapis_ore)}", $"minecraft:{nameof(Textures.deepslate_lapis_ore)}", "minecraft:deepslate_lapis_ore"),
                        new Material("1.17", true, "Ores (Deepslate)", "ORE_D_DS", "Deepslate Diamond Ore", NA, 0, Textures.deepslate_diamond_ore, Textures.deepslate_diamond_ore, $"minecraft:{nameof(Textures.deepslate_diamond_ore)}", $"minecraft:{nameof(Textures.deepslate_diamond_ore)}", "minecraft:deepslate_diamond_ore"),
                        new Material("1.17", true, "Ores (Deepslate)", "ORE_E_DS", "Deepslate Emerald Ore", NA, 0, Textures.deepslate_emerald_ore, Textures.deepslate_emerald_ore, $"minecraft:{nameof(Textures.deepslate_emerald_ore)}", $"minecraft:{nameof(Textures.deepslate_emerald_ore)}", "minecraft:deepslate_emerald_ore"),
