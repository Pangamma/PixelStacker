            ...
            get
            {
                if (_List == null)
                {
                    ...
                    _List = new List<Material>()
                    {
                        ...
                        new Material("1.7", true, "Glass", "GLASS_03", "Light Blue Glass", 95, 3, Textures.light_blue_stained_glass, Textures.light_blue_stained_glass, $"minecraft:{nameof(Textures.light_blue_stained_glass)}", $"minecraft:{nameof(Textures.light_blue_stained_glass)}", "minecraft:stained_glass"),
