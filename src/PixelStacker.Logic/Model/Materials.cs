            ...
            get
            {
                if (_List == null)
                {
                    ...
                    _List = new List<Material>()
                    {
                        ...
                        new Material("1.11", false, "Shulker", "SHULKER_00", "White Shulker Box", Textures.GetBitmap("white_shulker_box"), Textures.GetCustomBitmap("white_shulker_box_side"), $"minecraft:white_shulker_box", $"minecraft:white_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_01", "Orange Shulker Box", Textures.GetBitmap("orange_shulker_box"), Textures.GetCustomBitmap("orange_shulker_box_side"), $"minecraft:orange_shulker_box", $"minecraft:orange_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_02", "Magenta Shulker Box", Textures.GetBitmap("magenta_shulker_box"), Textures.GetCustomBitmap("magenta_shulker_box_side"), $"minecraft:magenta_shulker_box", $"minecraft:magenta_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_03", "Light Blue Shulker Box", Textures.GetBitmap("light_blue_shulker_box"), Textures.GetCustomBitmap("light_blue_shulker_box_side"), $"minecraft:light_blue_shulker_box", $"minecraft:light_blue_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_04", "Yellow Shulker Box", Textures.GetBitmap("yellow_shulker_box"), Textures.GetCustomBitmap("yellow_shulker_box_side"), $"minecraft:yellow_shulker_box", $"minecraft:yellow_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_05", "Lime Shulker Box", Textures.GetBitmap("lime_shulker_box"), Textures.GetCustomBitmap("lime_shulker_box_side"), $"minecraft:lime_shulker_box", $"minecraft:lime_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_06", "Pink Shulker Box",  Textures.GetBitmap("pink_shulker_box"), Textures.GetCustomBitmap("pink_shulker_box_side"), $"minecraft:pink_shulker_box", $"minecraft:pink_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_07", "Gray Shulker Box",Textures.GetBitmap("gray_shulker_box"), Textures.GetCustomBitmap("gray_shulker_box_side"), $"minecraft:gray_shulker_box", $"minecraft:gray_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_08", "Light Gray Shulker Box",  Textures.GetBitmap("light_gray_shulker_box"), Textures.GetCustomBitmap("light_gray_shulker_box_side"), $"minecraft:light_gray_shulker_box", $"minecraft:light_gray_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_09", "Cyan Shulker Box", Textures.GetBitmap("cyan_shulker_box"), Textures.GetCustomBitmap("cyan_shulker_box_side"), $"minecraft:cyan_shulker_box", $"minecraft:cyan_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_10", "Purple Shulker Box",  Textures.GetBitmap("purple_shulker_box"), Textures.GetCustomBitmap("purple_shulker_box_side"), $"minecraft:purple_shulker_box", $"minecraft:purple_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_11", "Blue Shulker Box",  Textures.GetBitmap("blue_shulker_box"), Textures.GetCustomBitmap("blue_shulker_box_side"), $"minecraft:blue_shulker_box", $"minecraft:blue_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_12", "Brown Shulker Box", Textures.GetBitmap("brown_shulker_box"), Textures.GetCustomBitmap("brown_shulker_box_side"), $"minecraft:brown_shulker_box", $"minecraft:brown_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_13", "Green Shulker Box",  Textures.GetBitmap("green_shulker_box"), Textures.GetCustomBitmap("green_shulker_box_side"), $"minecraft:green_shulker_box", $"minecraft:green_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_14", "Red Shulker Box", Textures.GetBitmap("red_shulker_box"), Textures.GetCustomBitmap("red_shulker_box_side"), $"minecraft:red_shulker_box", $"minecraft:red_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_15", "Black Shulker Box", Textures.GetBitmap("black_shulker_box"), Textures.GetCustomBitmap("black_shulker_box_side"), $"minecraft:black_shulker_box", $"minecraft:black_shulker_box", ""),
                        new Material("1.11", false, "Shulker", "SHULKER_XX", "Shulker Box", Textures.GetBitmap("shulker_box"), Textures.GetCustomBitmap("shulker_box_side"), $"minecraft:shulker_box", $"minecraft:shulker_box", ""){ Tags = [TAG_EXTRA] },
                        ...
                        new Material("1.7", true, "Carpet", "CARPET_00", "White Carpet", Textures.GetBitmap("white_wool"), Textures.GetBitmap("white_wool"), $"minecraft:white_carpet", $"minecraft:white_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_01", "Orange Carpet", Textures.GetBitmap("orange_wool"), Textures.GetBitmap("orange_wool"), $"minecraft:orange_carpet", $"minecraft:orange_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_02", "Magenta Carpet", Textures.GetBitmap("magenta_wool"), Textures.GetBitmap("magenta_wool"), $"minecraft:magenta_carpet", $"minecraft:magenta_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_03", "Light Blue Carpet", Textures.GetBitmap("light_blue_wool"), Textures.GetBitmap("light_blue_wool"), $"minecraft:light_blue_carpet", $"minecraft:light_blue_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_04", "Yellow Carpet", Textures.GetBitmap("yellow_wool"), Textures.GetBitmap("yellow_wool"), $"minecraft:yellow_carpet", $"minecraft:yellow_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_05", "Lime Carpet", Textures.GetBitmap("lime_wool"), Textures.GetBitmap("lime_wool"), $"minecraft:lime_carpet", $"minecraft:lime_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_06", "Pink Carpet", Textures.GetBitmap("pink_wool"), Textures.GetBitmap("pink_wool"), $"minecraft:pink_carpet", $"minecraft:pink_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_07", "Gray Carpet", Textures.GetBitmap("gray_wool"), Textures.GetBitmap("gray_wool"), $"minecraft:gray_carpet", $"minecraft:gray_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_08", "Light Gray Carpet", Textures.GetBitmap("light_gray_wool"), Textures.GetBitmap("light_gray_wool"), $"minecraft:light_gray_carpet", $"minecraft:light_gray_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_09", "Cyan Carpet", Textures.GetBitmap("cyan_wool"), Textures.GetBitmap("cyan_wool"), $"minecraft:cyan_carpet", $"minecraft:cyan_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_10", "Purple Carpet", Textures.GetBitmap("purple_wool"), Textures.GetBitmap("purple_wool"), $"minecraft:purple_carpet", $"minecraft:purple_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_11", "Blue Carpet", Textures.GetBitmap("blue_wool"), Textures.GetBitmap("blue_wool"), $"minecraft:blue_carpet", $"minecraft:blue_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_12", "Brown Carpet", Textures.GetBitmap("brown_wool"), Textures.GetBitmap("brown_wool"), $"minecraft:brown_carpet", $"minecraft:brown_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_13", "Green Carpet", Textures.GetBitmap("green_wool"), Textures.GetBitmap("green_wool"), $"minecraft:green_carpet", $"minecraft:green_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_14", "Red Carpet", Textures.GetBitmap("red_wool"), Textures.GetBitmap("red_wool"), $"minecraft:red_carpet", $"minecraft:red_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.7", true, "Carpet", "CARPET_15", "Black Carpet", Textures.GetBitmap("black_wool"), Textures.GetBitmap("black_wool"), $"minecraft:black_carpet", $"minecraft:black_carpet", "minecraft:carpet") { IsObsolete = true },
                        new Material("1.17", true, "Carpet", "CARPET_MOSS", "Moss Carpet", Textures.GetBitmap("moss_block"), Textures.GetBitmap("moss_block"), $"minecraft:moss_carpet", $"minecraft:moss_carpet", "") {Tags = [TAG_EXTRA], IsObsolete = true },
                        ...
                        new Material("1.20", false, "Logs", "PLANK_BAMBOOMOSAIC", "Mosaics Bamboo", Textures.GetBitmap("bamboo_mosaic"), Textures.GetBitmap("bamboo_mosaic"), $"minecraft:bamboo_mosaic", $"minecraft:bamboo_mosaic", "minecraft:planks") { Tags = [TAG_EXTRA] },
                        ...
                        new Material("1.16", true, "Nether", "NYLIUM_CRIMSON", "Crimson Nylium", Textures.GetBitmap("crimson_nylium"), Textures.GetBitmap("crimson_nylium_side"), $"minecraft:crimson_nylium", $"minecraft:crimson_nylium", ""),
                        new Material("1.16", true, "Nether", "NYLIUM_WARPED", "Warped Nylium",  Textures.GetBitmap("warped_nylium"), Textures.GetBitmap("warped_nylium_side"), $"minecraft:warped_nylium", $"minecraft:warped_nylium", ""),
                        ...
                        new Material("1.13", false, "Coral", "DEAD_CRL_BRAIN", "Dead Brain Coral", Textures.GetBitmap("dead_brain_coral_block"), Textures.GetBitmap("dead_brain_coral_block"), $"minecraft:dead_brain_coral_block", $"minecraft:dead_brain_coral_block", ""),
                        new Material("1.13", false, "Coral", "DEAD_CRL_BUBBLE", "Dead Bubble Coral", Textures.GetBitmap("dead_bubble_coral_block"), Textures.GetBitmap("dead_bubble_coral_block"), $"minecraft:dead_bubble_coral_block", $"minecraft:dead_bubble_coral_block", ""),
                        new Material("1.13", false, "Coral", "DEAD_CRL_FIRE", "Dead Fire Coral", Textures.GetBitmap("dead_fire_coral_block"), Textures.GetBitmap("dead_fire_coral_block"), $"minecraft:dead_fire_coral_block", $"minecraft:dead_fire_coral_block", ""),
                        new Material("1.13", false, "Coral", "DEAD_CRL_HORN", "Dead Horn Coral", Textures.GetBitmap("dead_horn_coral_block"), Textures.GetBitmap("dead_horn_coral_block"), $"minecraft:dead_horn_coral_block", $"minecraft:dead_horn_coral_block", ""),
                        new Material("1.13", false, "Coral", "DEAD_CRL_TUBE", "Dead Tube Coral", Textures.GetBitmap("dead_tube_coral_block"), Textures.GetBitmap("dead_tube_coral_block"), $"minecraft:dead_tube_coral_block", $"minecraft:dead_tube_coral_block", ""),
                        ...
                        new Material("1.17", true, "Transparent", "Cu_GRATE", "Waxed Copper Grate", Textures.GetBitmap("copper_grate"), Textures.GetBitmap("copper_grate"), $"minecraft:waxed_copper_grate", $"minecraft:waxed_copper_grate", ""),
                        new Material("1.17", true, "Transparent", "Cu_GRATE_EXPO", "Waxed Exposed Copper Grate", Textures.GetBitmap("exposed_copper_grate"), Textures.GetBitmap("exposed_copper_grate"), $"minecraft:waxed_exposed_copper_grate", $"minecraft:waxed_exposed_copper_grate", ""),
                        new Material("1.17", true, "Transparent", "Cu_GRATE_WTHER", "Waxed Weathered Copper Grate", Textures.GetBitmap("weathered_copper_grate"), Textures.GetBitmap("weathered_copper_grate"), $"minecraft:waxed_weathered_copper_grate", $"minecraft:waxed_weathered_copper_grate", ""),
                        new Material("1.17", true, "Transparent", "Cu_GRATE_OXI", "Waxed Oxidized Copper Grate", Textures.GetBitmap("oxidized_copper_grate"), Textures.GetBitmap("oxidized_copper_grate"), $"minecraft:waxed_oxidized_copper_grate", $"minecraft:waxed_oxidized_copper_grate", ""),
                        ...
                        new Material("1.21.5", true, "Crafting", "DROPPER", "Dropper", Textures.GetBitmap("furnace_top"), Textures.GetBitmap("dropper_front"), $"minecraft:dropper[facing=south]", $"minecraft:dropper[facing=south]", ""),
                        new Material("1.21.5", true, "Crafting", "DISPENSER_TOP", "Dispenser (Top)", Textures.GetBitmap("dispenser_front_vertical"), Textures.GetBitmap("furnace_top"), $"minecraft:dispenser[facing=up]", $"minecraft:dispenser[facing=up]", ""),
                        new Material("1.21.5", true, "Crafting", "DISPENSER_FRONT", "Dispenser (Front)", Textures.GetBitmap("furnace_top"), Textures.GetBitmap("dispenser_front"), $"minecraft:dispenser[facing=south]", $"minecraft:dispenser[facing=south]", ""),
                        new Material("1.21.5", true, "Crafting", "DISPENSER_SIDE", "Dispenser (Side)", Textures.GetBitmap("furnace_top"), Textures.GetBitmap("furnace_side"), $"minecraft:dispenser[facing=north]", $"minecraft:dispenser[facing=north]", ""),
                        new Material("1.21.5", true, "Crafting", "LOOM_FRONT", "Loom (Front)", Textures.GetBitmap("loom_top"), Textures.GetBitmap("loom_front"), $"minecraft:loom[facing=south]", $"minecraft:loom[facing=south]", ""),
                        new Material("1.21.5", true, "Crafting", "LOOM_SIDE", "Loom (Top)", Textures.GetBitmap("loom_top"), Textures.GetBitmap("loom_side"), $"minecraft:loom[facing=north]", $"minecraft:loom[facing=north]", ""),
                        new Material("1.21.5", true, "Crafting", "SMOKER_FRONT", "Smoker (Front)", Textures.GetBitmap("smoker_top"), Textures.GetBitmap("smoker_front"), $"minecraft:smoker[facing=south,lit=false]", $"minecraft:smoker[facing=south,lit=false]", ""),
                        new Material("1.21.5", true, "Crafting", "SMOKER_SIDE", "Smoker (Side)", Textures.GetBitmap("smoker_top"), Textures.GetBitmap("smoker_side"), $"minecraft:smoker[facing=north,lit=true]", $"minecraft:smoker[facing=north,lit=true]", ""),
                        new Material("1.21.5", true, "Crafting", "BLAST_FURNACE_FRONT", "Blast Furnace (Front)", Textures.GetBitmap("blast_furnace_top"), Textures.GetBitmap("blast_furnace_front"), $"minecraft:blast_furnace[facing=south,lit=false]", $"minecraft:blast_furnace[facing=south,lit=false]", ""),
                        new Material("1.21.5", true, "Crafting", "BLAST_FURNACE_SIDE", "Blast Furnace (Side)", Textures.GetBitmap("blast_furnace_top"), Textures.GetBitmap("blast_furnace_side"), $"minecraft:blast_furnace[facing=north,lit=true]", $"minecraft:blast_furnace[facing=north,lit=true]", ""),
                        new Material("1.21.5", true, "Crafting", "FURNACE", "Furnace", Textures.GetBitmap("furnace_top"), Textures.GetBitmap("furnace_front"), $"minecraft:furnace[facing=south,lit=false]", $"minecraft:furnace[facing=south,lit=false]", ""),
                        new Material("1.21.5", true, "Crafting", "CRAFT_TABLE", "Crafting Table", Textures.GetBitmap("crafting_table_top"), Textures.GetBitmap("crafting_table_side"), $"minecraft:crafting_table", $"minecraft:crafting_table", ""),
                        new Material("1.21.5", true, "Crafting", "CARTOGRAPHY_TABLE", "Cartography Table", Textures.GetBitmap("cartography_table_top"), Textures.GetBitmap("cartography_table_side2"), $"minecraft:cartography_table", $"minecraft:cartography_table", ""),
                        new Material("1.21.5", true, "Crafting", "FLETCHING_TABLE", "Fletching Table", Textures.GetBitmap("fletching_table_top"), Textures.GetBitmap("fletching_table_front"), $"minecraft:fletching_table", $"minecraft:fletching_table", ""),
                        new Material("1.21.5", true, "Crafting", "SMITHING_TABLE", "Smithing Table", Textures.GetBitmap("smithing_table_top"), Textures.GetBitmap("smithing_table_front"), $"minecraft:smithing_table", $"minecraft:smithing_table", ""),
