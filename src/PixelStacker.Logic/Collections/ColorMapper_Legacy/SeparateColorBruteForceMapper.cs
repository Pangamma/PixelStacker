...
{
    public class SeparateColorBruteForceMapper : ILegacyColorMapper
    {
        public string AlgorithmTitle => "Unique Color Brute Force";
        ...
        public MaterialCombination FindBestMatch(SKColor c)
        {
            ...
            var found = Combos.MinBy(x => c.GetAverageColorDistance(x.GetColorsInImage(this.IsSideView), this.CalculateColorDistance));
            Cache[c] = found;
            return found;
        }
