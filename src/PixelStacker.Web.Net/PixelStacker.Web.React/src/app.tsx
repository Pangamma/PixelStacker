...
export class App extends React.PureComponent<AppProps, AppState> {
  private refEditor: React.RefObject<CanvasEditor> = React.createRef<CanvasEditor>();
  private refFileUploader: React.RefObject<FileUploader> = React.createRef<FileUploader>();
