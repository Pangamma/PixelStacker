...
namespace PixelStacker.Resources
{
    ...
    public class Shadows
    {
        ...
        public static SKBitmap sprite_x16
        {
            ...
            {
                if (_sprite_x16 == null)
                    _sprite_x16 = SKBitmap.Decode((byte[])ResourceManager.GetObject("sprite_x16"))
        ...
        public static SKBitmap sprite_x32
        {
            ...
            {
                if (_sprite_x32 == null)
                    _sprite_x32 = SKBitmap.Decode((byte[])ResourceManager.GetObject("sprite_x32"))
                    .Copy(SKColorType.Rgba8888);
                return _sprite_x32;
            }
        }
        ...
        public static SKBitmap sprite_x64
        {
            ...
            {
                if (_sprite_x64 == null)
                    _sprite_x64 = SKBitmap.Decode((byte[])ResourceManager.GetObject("sprite_x64"))
                    .Copy(SKColorType.Rgba8888);
                return _sprite_x64;
            }
        }
