...
namespace PixelStacker.Core.Engine.Quantizer.ColorCaches.Octree
{
    public class OctreeCacheNode
    {
        ...
        private readonly Dictionary<int, PxColor> entries;
        ...
        public OctreeCacheNode()
        {
            ...
            entries = new Dictionary<int, PxColor>();
        }
        ...
        public void AddColor(PxColor color, int paletteIndex, int level)
        {
        ...
        /// </summary>
        public Dictionary<int, PxColor> GetPaletteIndex(PxColor color, int level)
        {
            Dictionary<int, PxColor> result = entries;
        ...
        private static int GetColorIndexAtLevel(PxColor color, int level)
        {
