...
namespace PixelStacker.Core.Engine.Quantizer.Quantizers.Popularity
{
    internal class PopularityColorSlot
    {
        ...
        public PopularityColorSlot(PxColor color)
        {
            AddValue(color);
        }
        ...
        public PopularityColorSlot AddValue(PxColor color)
        {
            red += color.R;
            green += color.G;
            blue += color.B;
        ...
        public PxColor GetAverage()
        {
            ...
            return PxColor.FromArgb(255, finalRed, finalGreen, finalBlue);
        }
