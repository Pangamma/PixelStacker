...
namespace PixelStacker.Core.Engine.Quantizer.Quantizers.Popularity
{
    /// <summary>
    ...
    public class PopularityQuantizer : BaseColorCacheQuantizer
    {
        ...
        private static int GetColorIndex(PxColor color)
        {
        ...
        /// </summary>
        protected override List<PxColor> OnGetPaletteToCache(int colorCount)
        {
            ...
            IEnumerable<PxColor> colors = colorMap.
        ...
        /// </summary>
        public override string Label => "Popularity algorithm";
