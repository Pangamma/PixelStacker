    ...
    internal class OctreeNode
    {
        ...
        public PxColor Color
        {
            get
            {
                ...
                {
                    result = pixelCount == 1 ?
                        PxColor.FromArgb(255, red, green, blue) :
                        PxColor.FromArgb(255, red / pixelCount, green / pixelCount, blue / pixelCount);
                }
                else
                {
        ...
        public void AddColor(PxColor color, int level, OctreeQuantizer parent)
        {
        ...
        /// <param name="level">The level.</param>
        /// <returns></returns>
        public int GetPaletteIndex(PxColor color, int level)
        {
            int result;
