...
namespace PixelStacker.Core.Engine.Quantizer.Quantizers.OptimalPalette
{
    public class OptimalPaletteQuantizer : BaseColorCacheQuantizer
    {
        #region | Fields |

        private static readonly List<PxColor> OptimalPalette;
        ...
        {
            OptimalPalette = new List<PxColor>(256);
        ...
        /// </summary>
        public override string Label => "Optimal palette";
