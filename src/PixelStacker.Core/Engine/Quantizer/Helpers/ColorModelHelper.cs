...
namespace PixelStacker.Core.Engine.Quantizer.Helpers
{
    public class ColorModelHelper
    {
        ...
        public static PxColor HSBtoRGB(float hue, float saturation, float brightness)
        {
        ...
        public static long GetColorEuclideanDistance(ColorModel colorModel, PxColor requestedColor, PxColor realColor)
        {
        ...
        public static int GetEuclideanDistance(PxColor color, ColorModel colorModel, IList<PxColor> palette)
        {
            ...
            if (palette != null)
            {
                ...
                {
                    PxColor targetColor = palette[index];
        ...
        public static int GetComponentA(ColorModel colorModel, PxColor color)
        {
            int result = 0;
        ...
        public static int GetComponentB(ColorModel colorModel, PxColor color)
        {
            int result = 0;
        ...
        public static int GetComponentC(ColorModel colorModel, PxColor color)
        {
            int result = 0;
        ...
        public static void GetColorComponents(ColorModel colorModel, PxColor color, out float componentA, out float componentB, out float componentC)
        {
            componentA = 0.0f;
            componentB = 0.0f;
            componentC = 0.0f;
        ...
        public static void GetColorComponents(ColorModel colorModel, PxColor color, PxColor targetColor, out float componentA, out float componentB, out float componentC)
        {
            componentA = 0.0f;
            componentB = 0.0f;
            componentC = 0.0f;
