...
using PixelStacker.Core.Engine.Quantizer;
using PixelStacker.Core.Engine.SharpQuantizer;

namespace PixelStacker.Core.Engine
{
    ...
    public class RenderCanvasEngine
    {
        ...
        /// <returns></returns>
        public Task<PxBitmap> PreprocessImageAsync(CancellationToken? worker, PxBitmap LIM, CanvasPreprocessorSettings settings)
        {
            ...
            var resized = new PxBitmap(LIM, W, H);
            ...
            if (settings.QuantizerSettings?.IsEnabled == true)
            {
                ...
                var quantized = SharpQuantizeEngine.RenderImage(worker, resized, settings.QuantizerSettings);
        ...
        public Task<RenderedCanvas> RenderCanvasAsync(
            ...
            ref PxBitmap preprocessedImage,
            IColorMapper mapper,
