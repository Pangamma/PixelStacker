...
namespace PixelStacker.UI
{
    ...
    public partial class MainForm
    {
        ...
        private void TS_SetAllMenubarStatesBasedOnOptions(Options opts)
        {
            ...
            this.toggleAdvancedModeToolStripMenuItem.Text = opts.IsAdvancedModeEnabled ? Resources.Text.DisableAdvancedMode : Resources.Text.EnableAdvancedMode;
        }
        ...
        public void TS_SetTagObjects()
        {
            ...
            this.preRenderToolStripMenuItem.ModifyRecursive((x, tag) => tag.IsAdvancedOnly = true);
            ...
            this.textureRoughnessToolStripMenuItem.ModifyRecursive((x, tag) => tag.IsAdvancedOnly = true);
        ...
        private void toggleAdvancedModeToolStripMenuItem_Click(object sender, System.EventArgs e)
        {
            var c = this;
            ...
            TS_SetAllMenubarStatesBasedOnOptions(c.Options);
        }

        private void checkSpigotToolStripMenuItem_Click(object sender, System.EventArgs e)
        {
#pragma warning disable CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
            TaskManager.Get.StartAsync(cancelToken => UpdateChecker.CheckForUpdatesManually(false, cancelToken));
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        }

        private void checkGithubToolStripMenuItem_Click(object sender, System.EventArgs e)
        {
#pragma warning disable CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
            TaskManager.Get.StartAsync(cancelToken => UpdateChecker.CheckForUpdatesManually(true, cancelToken));
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        }
