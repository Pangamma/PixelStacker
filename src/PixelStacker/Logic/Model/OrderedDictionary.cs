...
namespace System.Collections.Generic
{
    ...
    public class OrderedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IList<KeyValuePair<TKey, TValue>>
    {
        ...
        public OrderedDictionary(IDictionary<TKey, TValue> o)
        {
            ...
            Dictionary<TKey, TValue> oDic = o as Dictionary<TKey, TValue>;
        ...
        public void Insert(int index, TKey key, TValue value)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("index", index, "The index is negative -or- larger than the size of the dictionary.");
            }
            dictionary.Add(key, value);
        ...
        void ICollection<KeyValuePair<TKey, TValue>>.CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex)
        {
            ...
            if (arrayIndex < 0)
            {
                throw new ArgumentOutOfRangeException("arrayIndex", arrayIndex, String.Format(CultureInfo.InvariantCulture, "Index cannot be less than 0", 0));
            }
        ...
        public sealed class ValueCollection : ICollection<TValue>
        {
            ...
            public void CopyTo(TValue[] array, int arrayIndex)
            {
                ...
                if (arrayIndex < 0)
                {
                    throw new ArgumentOutOfRangeException("arrayIndex", arrayIndex, String.Format("Index cannot be less than 0", 0));
                }
