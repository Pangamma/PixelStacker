...
namespace PixelStacker.Logic
{
    public class Materials
    {
            ...
            get
            {
                if (_List == null)
                {
                    _List = new List<Material>()
                    {
                        ...
                        new Material("Concrete", "CONC_00", "White Concrete", 251, 0, Textures.white_concrete, Textures.white_concrete, $"minecraft:{nameof(Textures.white_concrete)}", $"minecraft:{nameof(Textures.white_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_01", "Orange Concrete", 251, 1, Textures.orange_concrete, Textures.orange_concrete, $"minecraft:{nameof(Textures.orange_concrete)}", $"minecraft:{nameof(Textures.orange_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_02", "Magenta Concrete", 251, 2, Textures.magenta_concrete, Textures.magenta_concrete, $"minecraft:{nameof(Textures.magenta_concrete)}", $"minecraft:{nameof(Textures.magenta_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_03", "Light Blue Concrete", 251, 3, Textures.light_blue_concrete, Textures.light_blue_concrete, $"minecraft:{nameof(Textures.light_blue_concrete)}", $"minecraft:{nameof(Textures.light_blue_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_04", "Yellow Concrete", 251, 4, Textures.yellow_concrete, Textures.yellow_concrete, $"minecraft:{nameof(Textures.yellow_concrete)}", $"minecraft:{nameof(Textures.yellow_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_05", "Lime Concrete", 251, 5, Textures.lime_concrete, Textures.lime_concrete, $"minecraft:{nameof(Textures.lime_concrete)}", $"minecraft:{nameof(Textures.lime_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_06", "Pink Concrete", 251, 6, Textures.pink_concrete, Textures.pink_concrete, $"minecraft:{nameof(Textures.pink_concrete)}", $"minecraft:{nameof(Textures.pink_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_07", "Gray Concrete", 251, 7, Textures.gray_concrete, Textures.gray_concrete, $"minecraft:{nameof(Textures.gray_concrete)}", $"minecraft:{nameof(Textures.gray_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_08", "Light Gray Concrete", 251, 8, Textures.light_gray_concrete, Textures.light_gray_concrete, $"minecraft:{nameof(Textures.light_gray_concrete)}", $"minecraft:{nameof(Textures.light_gray_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_09", "Cyan Concrete", 251, 9, Textures.cyan_concrete, Textures.cyan_concrete, $"minecraft:{nameof(Textures.cyan_concrete)}", $"minecraft:{nameof(Textures.cyan_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_10", "Purple Concrete", 251, 10, Textures.purple_concrete, Textures.purple_concrete, $"minecraft:{nameof(Textures.purple_concrete)}", $"minecraft:{nameof(Textures.purple_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_11", "Blue Concrete", 251, 11, Textures.blue_concrete, Textures.blue_concrete, $"minecraft:{nameof(Textures.blue_concrete)}", $"minecraft:{nameof(Textures.blue_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_12", "Brown Concrete", 251, 12, Textures.brown_concrete, Textures.brown_concrete, $"minecraft:{nameof(Textures.brown_concrete)}", $"minecraft:{nameof(Textures.brown_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_13", "Green Concrete", 251, 13, Textures.green_concrete, Textures.green_concrete, $"minecraft:{nameof(Textures.green_concrete)}", $"minecraft:{nameof(Textures.green_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_14", "Red Concrete", 251, 14, Textures.red_concrete, Textures.red_concrete, $"minecraft:{nameof(Textures.red_concrete)}", $"minecraft:{nameof(Textures.red_concrete)}", "minecraft:concrete" ),
                        new Material("Concrete", "CONC_15", "Black Concrete", 251, 15, Textures.black_concrete, Textures.black_concrete, $"minecraft:{nameof(Textures.black_concrete)}", $"minecraft:{nameof(Textures.black_concrete)}", "minecraft:concrete" ),

                        new Material("Powder", "PWDR_00", "White Powder", 252, 0, Textures.white_concrete_powder, Textures.white_concrete_powder, $"minecraft:{nameof(Textures.white_concrete_powder)}", $"minecraft:{nameof(Textures.white_concrete_powder)}", "minecraft:concrete_powder"),
                        new Material("Powder", "PWDR_01", "Orange Powder", 252, 1, Textures.orange_concrete_powder, Textures.orange_concrete_powder, $"minecraft:{nameof(Textures.orange_concrete_powder)}", $"minecraft:{nameof(Textures.orange_concrete_powder)}", "minecraft:concrete_powder" ),
                        new Material("Powder", "PWDR_02", "Magenta Powder", 252, 2, Textures.magenta_concrete_powder, Textures.magenta_concrete_powder, $"minecraft:{nameof(Textures.magenta_concrete_powder)}", $"minecraft:{nameof(Textures.magenta_concrete_powder)}", "minecraft:concrete_powder" ),
                        new Material("Powder", "PWDR_03", "Light Blue Powder", 252, 3, Textures.light_blue_concrete_powder, Textures.light_blue_concrete_powder, $"minecraft:{nameof(Textures.light_blue_concrete_powder)}", $"minecraft:{nameof(Textures.light_blue_concrete_powder)}", "minecraft:concrete_powder" ),
                        new Material("Powder", "PWDR_04", "Yellow Powder", 252, 4, Textures.yellow_concrete_powder, Textures.yellow_concrete_powder, $"minecraft:{nameof(Textures.yellow_concrete_powder)}", $"minecraft:{nameof(Textures.yellow_concrete_powder)}", "minecraft:concrete_powder" ),
                        new Material("Powder", "PWDR_05", "Lime Powder", 252, 5, Textures.lime_concrete_powder, Textures.lime_concrete_powder, $"minecraft:{nameof(Textures.lime_concrete_powder)}", $"minecraft:{nameof(Textures.lime_concrete_powder)}", "minecraft:concrete_powder" ),
                        new Material("Powder", "PWDR_06", "Pink Powder", 252, 6, Textures.pink_concrete_powder, Textures.pink_concrete_powder, $"minecraft:{nameof(Textures.pink_concrete_powder)}", $"minecraft:{nameof(Textures.pink_concrete_powder)}", "minecraft:concrete_powder" ),
                        new Material("Powder", "PWDR_07", "Gray Powder", 252, 7, Textures.gray_concrete_powder, Textures.gray_concrete_powder, $"minecraft:{nameof(Textures.gray_concrete_powder)}", $"minecraft:{nameof(Textures.gray_concrete_powder)}", "minecraft:concrete_powder" ),
                        new Material("Powder", "PWDR_08", "Light Gray Powder", 252, 8, Textures.light_gray_concrete_powder, Textures.light_gray_concrete_powder, $"minecraft:{nameof(Textures.light_gray_concrete_powder)}", $"minecraft:{nameof(Textures.light_gray_concrete_powder)}", "minecraft:concrete_powder" ),
                        new Material("Powder", "PWDR_09", "Cyan Powder", 252, 9, Textures.cyan_concrete_powder, Textures.cyan_concrete_powder, $"minecraft:{nameof(Textures.cyan_concrete_powder)}", $"minecraft:{nameof(Textures.cyan_concrete_powder)}", "minecraft:concrete_powder" ),
                        new Material("Powder", "PWDR_10", "Purple Powder", 252, 10, Textures.purple_concrete_powder, Textures.purple_concrete_powder, $"minecraft:{nameof(Textures.purple_concrete_powder)}", $"minecraft:{nameof(Textures.purple_concrete_powder)}", "minecraft:concrete_powder" ),
                        new Material("Powder", "PWDR_11", "Blue Powder", 252, 11, Textures.blue_concrete_powder, Textures.blue_concrete_powder, $"minecraft:{nameof(Textures.blue_concrete_powder)}", $"minecraft:{nameof(Textures.blue_concrete_powder)}", "minecraft:concrete_powder" ),
                        new Material("Powder", "PWDR_12", "Brown Powder", 252, 12, Textures.brown_concrete_powder, Textures.brown_concrete_powder, $"minecraft:{nameof(Textures.brown_concrete_powder)}", $"minecraft:{nameof(Textures.brown_concrete_powder)}", "minecraft:concrete_powder" ),
                        new Material("Powder", "PWDR_13", "Green Powder", 252, 13, Textures.green_concrete_powder, Textures.green_concrete_powder, $"minecraft:{nameof(Textures.green_concrete_powder)}", $"minecraft:{nameof(Textures.green_concrete_powder)}", "minecraft:concrete_powder" ),
                        new Material("Powder", "PWDR_14", "Red Powder", 252, 14, Textures.red_concrete_powder, Textures.red_concrete_powder, $"minecraft:{nameof(Textures.red_concrete_powder)}", $"minecraft:{nameof(Textures.red_concrete_powder)}", "minecraft:concrete_powder" ),
                        new Material("Powder", "PWDR_15", "Black Powder", 252, 15, Textures.black_concrete_powder, Textures.black_concrete_powder, $"minecraft:{nameof(Textures.black_concrete_powder)}", $"minecraft:{nameof(Textures.black_concrete_powder)}", "minecraft:concrete_powder" ),
                        ...
                        new Material("Planks", "PLANK_CRIMSON", "Planks Crimson", 1, 0, Textures.crimson_planks, Textures.crimson_planks, $"minecraft:{nameof(Textures.crimson_planks)}", $"minecraft:{nameof(Textures.crimson_planks)}",""),
                        new Material("Planks", "PLANK_WARPED", "Planks Warped", 1, 0, Textures.warped_planks, Textures.warped_planks, $"minecraft:{nameof(Textures.warped_planks)}", $"minecraft:{nameof(Textures.warped_planks)}", ""),
                        ...
                        new Material("Stripped", "STRIP_LOG_BIR", "Stripped Birch", 17, 0, Textures.stripped_birch_log, Textures.stripped_birch_log, $"minecraft:{nameof(Textures.stripped_birch_log)}[axis=x]", $"minecraft:{nameof(Textures.stripped_birch_log)}[axis=x]", ""),
                        ...
                        new Material("Stripped", "STRIP_LOG_CRIMSON", "Stripped Crimson Stem", 1, 0, Textures.stripped_crimson_stem, Textures.stripped_crimson_stem, $"minecraft:{nameof(Textures.stripped_crimson_stem)}[axis=x]",$"minecraft:{nameof(Textures.stripped_crimson_stem)}[axis=x]", ""),
                        new Material("Stripped", "STRIP_LOG_WARPED", "Stripped Warped Stem", 1, 0, Textures.stripped_warped_stem, Textures.stripped_warped_stem, $"minecraft:{nameof(Textures.stripped_warped_stem)}[axis=x]",$"minecraft:{nameof(Textures.stripped_warped_stem)}[axis=x]", ""),
                        ...
                        new Material("Logs", "BARK_LOG_CRIMSON", "Crimson Stem", 1, 0, Textures.crimson_stem, Textures.crimson_stem, $"minecraft:{nameof(Textures.crimson_stem)}[axis=x]",$"minecraft:{nameof(Textures.crimson_stem)}[axis=x]", ""),
                        new Material("Logs", "BARK_LOG_WARPED", "Warped Stem", 1, 0, Textures.warped_stem, Textures.warped_stem, $"minecraft:{nameof(Textures.warped_stem)}[axis=x]",$"minecraft:{nameof(Textures.warped_stem)}[axis=x]", ""),
                        ...
                        new Material("Good", "NETHER_WART_WARPED", "Warped Netherwart", 1, 0, Textures.warped_wart_block, Textures.warped_wart_block, $"minecraft:{nameof(Textures.warped_wart_block)}", $"minecraft:{nameof(Textures.warped_wart_block)}", ""),
                        ...
                        new Material("Okay", "MAGMA", "Magma", 213, 0, Textures.magma, Textures.magma, $"minecraft:{nameof(Textures.magma)}_block", $"minecraft:{nameof(Textures.magma)}_block", "minecraft:magma"),
                        ...
                        new Material("Okay", "OBSIDIAN_CRYING", "Crying Obsidian", 1, 0, Textures.crying_obsidian, Textures.crying_obsidian, $"minecraft:{nameof(Textures.crying_obsidian)}", $"minecraft:{nameof(Textures.crying_obsidian)}", ""),
                        ...
                        new Material("Okay", "NETHER_BRICK_RED", "Red Nether Bricks", 215, 0, Textures.red_nether_bricks, Textures.red_nether_bricks, $"minecraft:{nameof(Textures.red_nether_bricks)}", $"minecraft:{nameof(Textures.red_nether_bricks)}", "minecraft:red_nether_brick"),
                        ...
                        new Material("116", "SHROOMLIGHT", "Shroomlight", 1, 0, Textures.shroomlight, Textures.shroomlight, $"minecraft:{nameof(Textures.shroomlight)}", $"minecraft:{nameof(Textures.shroomlight)}", ""),
                        new Material("116", "SOUL_SOIL", "Soul Soil", 1, 0, Textures.soul_soil, Textures.soul_soil, $"minecraft:{nameof(Textures.soul_soil)}", $"minecraft:{nameof(Textures.soul_soil)}", ""),
                        ...
                        new Material("116", "ANCIENT_DEBRIS", "Ancient Debris", 1, 0, Textures.ancient_debris_top, Textures.ancient_debris_side, $"minecraft:ancient_debris", $"minecraft:ancient_debris", ""),
                        new Material("116", "BASALT", "Basalt", 1, 0, Textures.basalt_top, Textures.basalt_side, $"minecraft:basalt", $"minecraft:basalt", ""),
                        new Material("116", "NETHERITE_BLOCK", "Netherite Block", 1, 0, Textures.netherite_block, Textures.netherite_block, $"minecraft:netherite_block", $"minecraft:netherite_block", ""),
                        new Material("116", "NYLIUM_CRIMSON", "Crimson Nylium", 1, 0, Textures.crimson_nylium, Textures.crimson_nylium_side, $"minecraft:crimson_nylium", $"minecraft:crimson_nylium", ""),
                        new Material("116", "NYLIUM_WARPED", "Warped Nylium", 1, 0, Textures.warped_nylium, Textures.warped_nylium_side, $"minecraft:warped_nylium", $"minecraft:warped_nylium", ""),
                     
                        //new Material("116", "GRASS_BLOCK", "Grass", 1, 0, Textures.grass, Textures.grass, $"minecraft:warped_nylium", $"minecraft:warped_nylium", ""),
                        ...
                        new Material("Ores", "ORE_R", "Redstone Ore", 73, 0, Textures.redstone_ore, Textures.redstone_ore, $"minecraft:{nameof(Textures.redstone_ore)}", $"minecraft:{nameof(Textures.redstone_ore)}", "minecraft:redstone_ore"),
                        new Material("Ores", "ORE_L", "Lapis Ore", 21, 0, Textures.lapis_ore, Textures.lapis_ore, $"minecraft:{nameof(Textures.lapis_ore)}", $"minecraft:{nameof(Textures.lapis_ore)}", "minecraft:lapis_ore"),
                        new Material("Ores", "ORE_D", "Diamond Ore", 56, 0, Textures.diamond_ore, Textures.diamond_ore, $"minecraft:{nameof(Textures.diamond_ore)}", $"minecraft:{nameof(Textures.diamond_ore)}", "minecraft:diamond_ore"),
        ...
        private static void AddTagsForColor(Color c, ref List<string> tags)
        {
            ...
            if (sat <= 0.20 || c.GetBrightness() <= 0.15 || c.GetBrightness() >= 0.85)
            {
                tags.Add("grayscale");
            ...
            else
            {
                ...
                // TODO: aqua, blue, purple, pink, brown
            }
        }
    }
}
