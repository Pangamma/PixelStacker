            ...
            get
            {
                if (_List == null)
                {
                    ...
                    _List = new List<Material>()
                    {
                        ...
                        new Material("1.17", false, "Ores (Solid)", "SLD_ORE_Cu_BLK", "Copper Block (Waxed)", 1, 0, Textures.cut_copper, Textures.cut_copper, $"minecraft:waxed_copper", $"minecraft:waxed_copper",""),
