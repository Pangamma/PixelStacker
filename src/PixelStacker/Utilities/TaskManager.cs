...
namespace PixelStacker.Utilities
{
    public class TaskManager
    {
        ...
        #region SafeReport
        [Obsolete]
        public static void SafeReport(int percent, string status) => ProgressTracker.SafeReport(percent, status);

        [Obsolete]
        public static void SafeReport(int percent) => ProgressTracker.SafeReport(percent);
        ...
        {
            if (callback == null) ProgressTracker.SafeReport(0, Text.Operation_Cancelled);
